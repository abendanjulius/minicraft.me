...
// ---- Version check ----
const APP_VERSION = '2.5.21'; // UPDATE ON EVERY RELEASE (with version.json + sw.js CACHE)
...
initUI({
  ...
  mineAim: (sx,sy)=>playerMod.setMineAim(sx,sy),
  punch: (sx,sy)=>playerMod.tryPunchAt(sx,sy),
