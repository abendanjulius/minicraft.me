...
export const ambLight = new THREE.AmbientLight(0xffffff, .6);
scene.add(ambLight);
export const sun = new THREE.DirectionalLight(0xffffff, .7);
sun.position.set(1, 2, .5);
scene.add(sun);

// Atmosphere (day/night, dome, stars) lives in sky.js — import from there
