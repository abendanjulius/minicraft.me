...
const CORE = [
  ...
  './js/eldercube.js', './js/keepstones.js', './js/claim.js', './js/map.js',
  './js/remeshQueue.js',
  './js/sky.js', './js/touch.js', './js/ai.js', './js/pathfind.js', './js/aitest.js', './js/buildings.js',
