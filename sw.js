...
const CACHE = 'minicraft-v11'  // UPDATE ON EVERY RELEASE (with version.json + APP_VERSION in main.js);
const CORE = [
  './', './index.html', './css/style.css', './manifest.json',
  './js/main.js', './js/world.js', './js/render.js', './js/player.js',
  './js/animals.js', './js/net.js', './js/ui.js', './js/audio.js', './js/survival.js', './js/mobs.js', './js/craft.js', './js/content.js', './js/mode.js',
